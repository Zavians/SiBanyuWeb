		...
		<aside class="main-sidebar">
			<section class="sidebar">
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li><a href="<?php echo base_url('beranda'); ?>"><i class="fa fa-home"></i>
							<span>Beranda</span></a>
					</li>
					...
					<li><a href="<?php echo base_url('penduduk/tampil_penduduk'); ?>"><i
								class="fa fa-address-card-o"></i> <span>Data
								Penduduk</span></a></li>
					...
					<!-- <li><a href="<?php echo base_url('kelahiran/tampil'); ?>"><i class="fa fa-book"
								aria-hidden="true"></i> <span>Data Kelahiran</span></a>
					</li> -->
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="<?php echo base_url('surat/surat_kelahiran'); ?>"><i
									...
									<span>Surat Kelahiran</span></a></li>
							<li><a href="<?php echo base_url('surat/surat_kematian'); ?>"><i
										class="fa fa-envelope-o"></i>
									<span>Surat Kematian</span></a></li>

							<li><a href="<?php echo base_url('surat/surat_buktinikah'); ?>"><i
										class="fa fa-envelope-o"></i>

									<span>Bukti Nikah</span></a></li>
							...
							<li><a href="<?php echo base_url('surat/sktm_kesehatan'); ?>"><i
										class="fa fa-envelope-o"></i> <span>SKTM
										Kesehatan</span></a></li>
							...
							<li><a href="<?php echo base_url('surat/izin_keluarga'); ?>"><i
										class="fa fa-envelope-o"></i>
									<span>Surat Izin Keluarga</span></a></li>
							...
							<li><a href="<?php echo base_url('surat/belum_menikah'); ?>"><i
										class="fa fa-envelope-o"></i> <span>SK
										Belum Menikah</span></a></li>
							<li><a href="<?php echo base_url('surat/belum_sekolah'); ?>"><i
										class="fa fa-envelope-o"></i> <span>SK
										Belum Sekolah</span></a></li>
