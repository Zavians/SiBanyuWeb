            ...
            <div class="box-body">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <label>RT</label>
                            <input type="text" name="rt" value="<?php echo isset($kelahiran->rt) ? $kelahiran->rt : ''; ?>"
                            class="form-control" required />
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control selectlive" name="rw" required>
                                <option value="<?php echo isset($kelahiran->rw) ? $kelahiran->rw : ''; ?>" selected>
                                    <?php echo isset($kelahiran->rw) ? $kelahiran->rw : ''; ?></option>
                            ...
                            <div class="form-group">
                                ...
                                value="<?php echo isset($kelahiran->keterangan) ? $kelahiran->keterangan : ''; ?>"
                                class="form-control" required />
                            </div>
                        </div>
                    </div>
