...
<br /><br /><br />
<font align="justify">
    Yang bertandatangan di bawah ini , <?php echo $sktm_pendidikan->jabatan_pejabat; ?> Desa Banyusri Kecamatan
...
<table width="100%">
    <tr>
        <td width="50%"></td>
        <td width="50%">
            <center>Banyusri, <?= date('d F Y', strtotime($sktm_pendidikan->tanggal_sktm_pendidikan)); ?></center>
        </td>
    </tr>
    <tr>
        <td></td>
