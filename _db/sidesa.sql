...
(3, 2, '3215261607780001', '2024-01-02');
...
(2, 1, '3215260112990001', '2019-11-25'),
(3, 3, '3215266909080001', '2024-01-02');
...
(2, 1, '3215260112990001', '2019-11-25'),
(3, 1, '3215267007900001', '2024-01-02');
...
(7, 1, '3215260401050001', '2024-01-02');
...
(4, 'Raihan Aditya Alfaridzi', 'Sabtu', 'Karwang', '2018-08-25', '00:00:00', 'Laki Laki', 'Pe', 'Laki Laki', 'Krajan 1 , Desa Banyusri kecamatan Wonosegoro Kota k', '3', '15', '3215262507750011', 'Karsa', 'wiraswasta', 'Krajan 1 , Desa Banyusri kecamatan Wonosegoro Kota Boyolali , 41371', '3215265404800010', 'Wiwin Maryani', 'Mengurus Rumah Tangga', 'Krajan 1 , Desa Banyusri kecamatan Wonosegoro Kota Boyolali , 41371'),
(5, 'Lavina Asmara Sofyana', 'Minggu', 'Boyolali', '2018-05-06', '07:05:00', 'Laki Laki', 'La', 'Perempuan', 'Sukamaju  Rt.010 Rw.003', '0', '0', '0000000000000000', 'Arga Sofyna', 'Buruh', 'Sukamaju  Rt.010 Rw.003', '0000000000000000', 'Maya Handayani', 'Mengurus Rumah Tangga', 'Sukamaju  Rt.010 Rw.003'),
(6, 'Nailla Zara Aditya', 'Kamis', 'Boyolali', '2019-07-11', '09:35:00', 'Laki Laki', 'La', 'Perempuan', 'Suka Mulya Rt.015/004', '0', '0', '0000000000000000', 'Aditya', 'Buruh', 'Suka Mulya Rt.015/004', '0000000000000000', 'Lindawati', 'Mengurus Rumah Tangga', 'Suka Mulya Rt.015/004'),
(7, 'Abdul Latip', 'Rabu', 'Boyolali', '2019-07-12', '19:30:00', 'Laki Laki', 'La', 'Laki Laki', 'Krajan I Rt 002 / 001', '0', '0', '0000000000000000', 'Nanasupriyatna', 'Buruh', 'Krajan I Rt 002 / 001', '0000000000000000', 'Resti', 'Mengurus Rumah Tangga', 'Krajan I Rt 002 / 001'),
(8, 'Aidil Akbar Sentosa', 'Kamis', 'Boyolali', '2019-08-19', '00:00:00', 'Laki Laki', 'La', 'Laki Laki', 'SukaMulya RT.015 / 05', '0', '0', '0000000000000000', 'Firman', 'Buruh', 'SukaMulya RT.015 / 05', '0000000000000000', 'Nuraeni Halim', ' Mengurus Rumah Tangga', 'SukaMulya RT.015 / 05'),
...
(10, 'Sofia Azzahra', 'Jumat', 'Boyolali', '2019-11-01', '00:03:00', 'Laki Laki', 'La', 'Laki Laki', 'Bukaper', '0', '0', '0000000000000000', 'Senjaya', 'Buruh', 'Bukaper', '0000000000000000', 'Intan Rahmawati', 'Mengurus Rumah Tangga', 'Bukaper'),
...
(12, 'Haris Rifqiyana Sofyan', 'Kamis', 'Boyolali', '2019-08-29', '14:49:00', 'Laki Laki', 'La', 'Laki Laki', 'Perum Gading Elok 2  RT 029 / 001', '0', '0', '0000000000000000', 'Ahmad Sofyan', 'Buruh', 'Perum Gading Elok 2  RT 029 / 001', '0000000000000000', 'Yani Septiani', 'Mengurus Rumah Tangga', 'Perum Gading Elok 2  RT 029 / 001'),
...
CREATE TABLE `kematian` (
  ...
  `hari_wafat` varchar(15) DEFAULT NULL,
...
INSERT INTO `kematian` (`id_kematian`, `nik`, `nama`, `jenis_kelamin`, `tempat_lahir`, `tanggal_lahir`, `agama`, `pekerjaan`, `alamat`, `rt`, `rw`, `hari_wafat`, `tanggal_wafat`, `pukul`, `keterangan`) VALUES
(1, '2242432424', 'SAMSUDIN', 'Laki Laki', 'AA', '0000-00-00', 'Islam', 'SSSS', 'SSS', '1', 'Kepal', 'Senin', '2023-12-31', '09:55:00', 'GAK TAU');
...
(4, 3, '3215260607060001', '2024-01-02');
...
(3215260112990001, 3215262108070011, 'Muhamad Husein', 'Boyolali', '1999-12-04', 'Laki Laki', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371       ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SMA', 'Belum Bkerja', 'Tetap', '-', 'Indonesia'),
(3215260400820003, 3215261009140482, 'Agus Saefudin', 'Boyolali', '1992-08-04', 'Laki Laki', 'Krajan 1 Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371 ', '003', 'Kepala Dusun Krajan 1', 'Islam', 'Menikah', 'SMA', 'Mahasiswa', 'Tetap', '-', 'Indonesia'),
(3215260401050001, 3215262108070011, 'Tedi Rahman', 'Boyolali', '2005-01-04', 'Laki Laki', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SMP', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215260607060001, 3215262108070011, 'Sugiri', 'Karwang', '2006-07-06', 'Laki Laki', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SMP', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215261607780001, 3215267007900001, 'Suhendar', 'Boyolali', '1987-07-16', 'Laki Laki', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371  ', '001', 'Kepala Dusun Sukamaju', 'Islam', 'Menikah', 'SMP', 'Buruh', 'Tetap', '-', 'Indonesia'),
(3215262207990004, 3215261009140482, 'Angga Nugraha', 'Boyolali', '1999-07-22', 'Laki Laki', 'Krajan 1 Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371 ', '003', 'Kepala Dusun Krajan 1', 'Islam', 'Belum Menikah', 'SMA', 'Pelajar', 'Tetap', '-', 'Indonesia'),
(3215262701170002, 3215262108070011, 'David Syahputra', 'Boyolali', '2017-01-21', 'Laki Laki', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'Tidak Sekolah', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215264206720008, 3215262108070011, 'Sarni', 'Boyolali', '1972-08-02', 'Perempuan', 'Krajan 1 Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371       ', '003', 'Kepala Dusun Krajan 1', 'Islam', 'Belum Menikah', 'Tidak Tamat SD', 'Mengurus Rumah Tangg', 'Tetap', '-', 'Indonesia'),
(3215265010760002, 3215260807190011, 'Entin Sutini', 'Boyolali', '1976-10-10', 'Perempuan', 'Krajan 1', '002', 'Kepala Dusun Krajan 1', 'Islam', 'Belum Menikah', 'SMA', 'Mengurus Rumah Tangg', 'Tetap', '-', 'Indonesia'),
(3215266909080001, 3215262108070011, 'Rita Khodijah', 'Boyolali', '2008-09-29', 'Perempuan', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371 ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Belum Menikah', 'SD', 'Belum Bekerja', 'Tetap', '-', 'Indonesia'),
(3215267007900001, 3215262108070011, 'Ijah', 'Boyolali', '1990-07-30', 'Perempuan', 'Sukamaju ,Desa Warung Bambu , Kecamatan Wonosegoro Kota Karawan. 41371    ', '010', 'Kepala Dusun Sukamaju', 'Islam', 'Menikah', 'SMA', 'Megurus Rumah Tangga', 'Tetap', '-', 'Indonesia');
...
(2, 2, '3215260112990001', 'apa saja', 2125, '2019-11-25');
...
(1, 1, '75765757', '111111111', 'Keamanan', 'Kp cikedokan desa sukadanau Rt 01/01 dusun 1 no 142, cikarang barat', 'adsd', '7', '77676', 'kkuhuhb', '17845', 'Tegal', 'Jawa Tengah', 17845, '087730384035', '2019-11-19'),
...
INSERT INTO `pindahdatang` (`no_kk`, `nama_kepala_keluarga`, `alamat`, `rt`, `rw`, `nik`, `nama`, `alasan_pindah`, `alamat_tujuan`, `jenis_pindah`, `klasifikasi_pindah`, `status_kk_pindah`, `status_kk_tdk_pindah`, `agama`, `pekerjaan`, `tanggal_pindah`) VALUES
(3215260203160013, 'Nasih Sunarwan', 'Sukamulya ', '15', 'Kepala Dusun Sukamulya', 'Nasih sunarwan', '3215260203160013', 'Keluarga', 'Krajan II rt 11 / 002  ', 'Kepala Keluarga dan Seluruh Anggota Keluarga', 'Dalam satu Desa', 'Nomor KK Tetap', 'Nomor KK Tetap', NULL, NULL, NULL),
(3215261310170007, 'Iwan Kosasih ', 'Krajan 2 . RT 006 / 002    ', '006', 'Kepala Dusun Krajan 2', '3215261310170007', 'Iwan Kosasih ', 'Pekerjaan', 'Gintung RT 001 /003 Kutamekar Ciampel    ', 'Kepala Keluarga', 'Antar Kecamatan', 'Nomor KK Tetap', 'Nomor KK Tetap', 'Islam', 'wiraswasta', '0000-00-00'),
(3215261604100004, 'Melani', 'Sukamulya', '16', 'Kepala Dusun Sukamulya', '3215261604100004', 'Meelani', 'Pekerjaan', 'Dusun Sentul RT 001 / 001 Cikampek', 'Kepala Keluarga dan Seluruh Anggota Keluarga', 'Antar Kab/Kota', 'Nomor KK Tetap', '', NULL, NULL, NULL),
(3215262401110019, 'A Dadang Juhara', 'Krajan 1   ', '001', 'Kepala Dusun Krajan 1', '3215262401110019', 'A Dadang Juhara', 'Pekerjaan', 'Jl Veteran Guro RT  001/ 001 no )3 Boyolali Wetan   ', 'Kepala Keluarga', 'Antar Desa', 'Nomor KK Tetap', 'Nomor KK Tetap', NULL, NULL, NULL),
(3215263105110013, 'Andri Apriyani', 'Sukamulya', '17', 'Kepala Dusun Sukamulya', '3215263105110013', 'Andri Apriyani', 'Keluarga', 'Cinangsi RT 002 / 008 Selaksana Bungutsari Tasikmalaya', 'Kepala Keluarga dan Seluruh Anggota Keluarga', 'Antar Kab/Kota', 'Nomor KK Tetap', '', NULL, NULL, NULL),
(3216111005810010, 'Suryat Man Epeur', 'Wanajaya', '21', 'Kepala Dusun WarnaJaya', '3216111005810010', 'Suryat Man Epeur', 'Pekerjaan', 'Ciluwang Selak ', 'Kepala Keluarga dan Seluruh Anggota Keluarga', 'Antar Kecamatan', 'Nomor KK Tetap', '', NULL, NULL, NULL),
(3278080708830003, 'Dede Kurnia', 'Sukamaju ', '011', 'Kepala Dusun Sukamaju', '3278080708830003', 'Dede Kurnia', 'Keluarga', 'Pangatang Bawah No.10/ 17 C RT 008 / 008 Boyolali', 'Kepala Keluarga dan Sebagian Keluarga lainnya', 'Antar Desa', 'Nomor KK Tetap', '', NULL, NULL, NULL);
...
(8, 2, '3215260401050001', '3215260607060001', '2024-01-02');
...
(6, 1, '3215260112990001', '3215264206720008', '3215260112990001', 'SANDIKA JAYA', 'Laki-Laki', 'RSUD', '2024-01-02', '09:39', 'Senin', 'PELAPOR', '2024-01-02');
...
(3, 1, '3215260112990001', '3215260112990001', 12, 'tegall', '1998-09-16', '11:11', 'Senin', '', 'sa', '2019-11-25'),
...
('admin', '21232f297a57a5a743894a0e4a801fc3', 'Tibor', 'admin'),
('kepaladesa', 'dabacc3bca86c8e5120e33bc112363b6', 'Slamet', 'kepaladesa'),
('sekdes', 'cee7a77b9db0dc8ceaf40962ba25f473', 'Rohman', 'sekertaris');
...
--
ALTER TABLE `belum_menikah`
  MODIFY `id_belum_menikah` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `cerai_mati`
  MODIFY `id_cerai_mati` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `haji`
  MODIFY `id_haji` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `menikah`
  MODIFY `id_menikah` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `sktm_kesehatan`
  MODIFY `id_sktm_kesehatan` int(50) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
